...
const jobTitle1 = document.querySelector(".jobTitle1")
...
let projectBtn = document.querySelectorAll(".projectButton")
...
projectBtn[0].addEventListener("click", () => {
    window.open("https://dhavalbhimani44.github.io/E-Commerce-Website/")
})

projectBtn[1].addEventListener("click", () => {
    window.open("https://github.com/DhavalBhimani44/Zoom-Automation")
})

boxContainer.addEventListener("click", () => {
    window.open("https://github.com/DhavalBhimani44")
})
